...
class ServoMoveRobotAction : public BT::StatefulActionNode {
 public:
  ServoMoveRobotAction(const std::string&, const BT::NodeConfig&,
  ...
  static BT::PortsList providedPorts() {
    return {BT::InputPort<std::string>("name_mark")};
  }
